...
This project aims to predict residential home prices in Ames, Iowa, using a variety of machine learning regression techniques.  
...
Libraries: pandas, numpy, scikit-learn, ydata-profiling  

Environment: Jupyter Notebook (PyTorch GPU kernel)  

## 📂 Structure  
Playground.ipynb: The main research and modeling sandbox.  

requirements.txt: List of dependencies.  

Dataset overview.html: Detailed exploratory data analysis report.
